...
import 'assets_audio_player_adapter.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  final _player = AssetsAudioPlayerPlayer();
  ...
  Future<void> _loadSong() async {
    await _player.load('https://play.radio.br:8089/mngaribaldi/mngaribaldi/icecast.audio');
